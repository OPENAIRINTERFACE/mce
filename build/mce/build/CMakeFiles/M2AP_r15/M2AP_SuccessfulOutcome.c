...
select_SuccessfulOutcome_M2AP_criticality_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	...
	const long *constraining_value = (const long *)((const char *)parent_sptr + offsetof(struct M2AP_SuccessfulOutcome, procedureCode));
...
static asn_type_selector_result_t
select_SuccessfulOutcome_M2AP_value_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	asn_type_selector_result_t result = {0, 0};
	const asn_ioc_set_t *itable = asn_IOS_M2AP_M2AP_ELEMENTARY_PROCEDURES_1;
	size_t constraining_column = 3; /* &procedureCode */
...
static asn_TYPE_member_t asn_MBR_M2AP_value_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct M2AP_SuccessfulOutcome__value, choice.SessionStartResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_M2AP_SessionStartResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"SessionStartResponse"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct M2AP_SuccessfulOutcome__value, choice.SessionStopResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_M2AP_SessionStopResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"SessionStopResponse"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct M2AP_SuccessfulOutcome__value, choice.SessionUpdateResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_M2AP_SessionUpdateResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"SessionUpdateResponse"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct M2AP_SuccessfulOutcome__value, choice.MbmsSchedulingInformationResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_M2AP_MbmsSchedulingInformationResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"MbmsSchedulingInformationResponse"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct M2AP_SuccessfulOutcome__value, choice.ResetAcknowledge),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_M2AP_ResetAcknowledge,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ResetAcknowledge"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct M2AP_SuccessfulOutcome__value, choice.M2SetupResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_M2AP_M2SetupResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"M2SetupResponse"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct M2AP_SuccessfulOutcome__value, choice.ENBConfigurationUpdateAcknowledge),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_M2AP_ENBConfigurationUpdateAcknowledge,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ENBConfigurationUpdateAcknowledge"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct M2AP_SuccessfulOutcome__value, choice.MCEConfigurationUpdateAcknowledge),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_M2AP_MCEConfigurationUpdateAcknowledge,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"MCEConfigurationUpdateAcknowledge"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct M2AP_SuccessfulOutcome__value, choice.MbmsServiceCountingResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_M2AP_MbmsServiceCountingResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
...
static const asn_TYPE_tag2member_t asn_MAP_M2AP_value_tag2el_4[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 8 }, /* SessionStartResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, -1, 7 }, /* SessionStopResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, -2, 6 }, /* SessionUpdateResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, -3, 5 }, /* MbmsSchedulingInformationResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 4, -4, 4 }, /* ResetAcknowledge */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 5, -5, 3 }, /* M2SetupResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 6, -6, 2 }, /* ENBConfigurationUpdateAcknowledge */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 7, -7, 1 }, /* MCEConfigurationUpdateAcknowledge */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 8, -8, 0 } /* MbmsServiceCountingResponse */
};
static asn_CHOICE_specifics_t asn_SPC_M2AP_value_specs_4 = {
	sizeof(struct M2AP_SuccessfulOutcome__value),
	offsetof(struct M2AP_SuccessfulOutcome__value, _asn_ctx),
	offsetof(struct M2AP_SuccessfulOutcome__value, present),
	sizeof(((struct M2AP_SuccessfulOutcome__value *)0)->present),
...
asn_TYPE_member_t asn_MBR_M2AP_SuccessfulOutcome_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct M2AP_SuccessfulOutcome, procedureCode),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct M2AP_SuccessfulOutcome, criticality),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_M2AP_Criticality,
		select_SuccessfulOutcome_M2AP_criticality_type,
		{ &asn_OER_memb_M2AP_criticality_constr_3, &asn_PER_memb_M2AP_criticality_constr_3,  memb_M2AP_criticality_constraint_1 },
		0, 0, /* No default value */
		"criticality"
		},
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct M2AP_SuccessfulOutcome, value),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_M2AP_value_4,
		select_SuccessfulOutcome_M2AP_value_type,
		{ &asn_OER_memb_M2AP_value_constr_4, &asn_PER_memb_M2AP_value_constr_4,  memb_M2AP_value_constraint_1 },
		0, 0, /* No default value */
		"value"
		},
};
static const ber_tlv_tag_t asn_DEF_M2AP_SuccessfulOutcome_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_M2AP_SuccessfulOutcome_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* procedureCode */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* criticality */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* value */
};
asn_SEQUENCE_specifics_t asn_SPC_M2AP_SuccessfulOutcome_specs_1 = {
	sizeof(struct M2AP_SuccessfulOutcome),
	offsetof(struct M2AP_SuccessfulOutcome, _asn_ctx),
	asn_MAP_M2AP_SuccessfulOutcome_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_M2AP_SuccessfulOutcome = {
	"SuccessfulOutcome",
	"SuccessfulOutcome",
	&asn_OP_SEQUENCE,
	asn_DEF_M2AP_SuccessfulOutcome_tags_1,
	sizeof(asn_DEF_M2AP_SuccessfulOutcome_tags_1)
		/sizeof(asn_DEF_M2AP_SuccessfulOutcome_tags_1[0]), /* 1 */
	asn_DEF_M2AP_SuccessfulOutcome_tags_1,	/* Same as above */
	sizeof(asn_DEF_M2AP_SuccessfulOutcome_tags_1)
		/sizeof(asn_DEF_M2AP_SuccessfulOutcome_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_M2AP_SuccessfulOutcome_1,
	3,	/* Elements count */
	&asn_SPC_M2AP_SuccessfulOutcome_specs_1	/* Additional specs */
};
