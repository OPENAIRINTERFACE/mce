 ...
 */
static asn_oer_constraints_t asn_OER_type_M2AP_cellReservationInfo_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_M2AP_cellReservationInfo_3 = {
	...
	{ &asn_OER_type_M2AP_cellReservationInfo_constr_3, &asn_PER_type_M2AP_cellReservationInfo_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_M2AP_Cell_Information_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct M2AP_Cell_Information, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_M2AP_ProtocolExtensionContainer_1875P5,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
