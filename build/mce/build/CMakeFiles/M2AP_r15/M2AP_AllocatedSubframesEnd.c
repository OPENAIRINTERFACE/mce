 ...
 */
static asn_oer_constraints_t asn_OER_type_M2AP_AllocatedSubframesEnd_constr_1 CC_NOTUSED = {
	{ 2, 1 }	/* (0..1535) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_M2AP_AllocatedSubframesEnd = {
	...
	sizeof(asn_DEF_M2AP_AllocatedSubframesEnd_tags_1)
		/sizeof(asn_DEF_M2AP_AllocatedSubframesEnd_tags_1[0]), /* 1 */
	{ &asn_OER_type_M2AP_AllocatedSubframesEnd_constr_1, &asn_PER_type_M2AP_AllocatedSubframesEnd_constr_1, M2AP_AllocatedSubframesEnd_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
