    ...
    )
{
  ...
  mce_app_mbms_proc_t				 	 					 *mbms_sm_proc 								= NULL;
   ...
   */
  DevAssert(mce_app_create_mbms_procedure(&mbms_service, mbms_session_start_request_pP->abs_start_time.sec_since_epoch,
    ...
    )
{
  ...
  mbms_sm_proc = mce_app_create_mbms_procedure(mbms_service, mbms_session_update_request_pP->abs_update_time.sec_since_epoch,
    ...
    )
{
  ...
  if(mbms_session_stop_request_pP->abs_stop_time.sec_since_epoch && !mbms_session_stop_request_pP->mbms_flags.lmri){
  	mce_app_create_mbms_procedure(mbms_service, mbms_session_stop_request_pP->abs_stop_time.sec_since_epoch,
...
mce_app_handle_mbms_session_duration_timer_expiry (const struct tmgi_s *tmgi, const mbms_service_area_id_t mbms_service_area_id)
{
  ...
  mbms_service_t								*mbms_service    		= NULL;
  mce_app_mbms_proc_t						*mce_app_mbms_proc 	= NULL;
  mbms_service_index_t					 mbms_service_idx   = INVALID_MBMS_SERVICE_INDEX;
  ...
  if(mce_app_mbms_proc->trigger_mbms_session_stop) {
