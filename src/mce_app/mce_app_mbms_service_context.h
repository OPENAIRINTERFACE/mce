...
//		  long 												mbms_service_mcch_stop_period;
  ...
  mce_app_mbms_proc_t					 *mbms_procedure;			  ///< Allowing a single MBMS procedure in the MBMS-Service.
 ...
 * SM Procedures.
 */
mce_app_mbms_proc_t* mce_app_create_mbms_procedure(mbms_service_t * mbms_service, long delta_to_start_in_sec, long delta_to_start_in_usec, const mbms_session_duration_t * const mbms_session_duration);
