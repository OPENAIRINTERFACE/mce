...
void mce_app_itti_sm_mbms_session_start_response(teid_t mce_sm_teid, teid_t mbms_sm_teid, struct sockaddr *mbms_ip_address, void *trxn,  gtpv2c_cause_value_t gtpv2cCause){
  ...
  if(mce_sm_teid != INVALID_TEID){
    ...
    if(mce_config.mbms.ip.mc_mce_v4.s_addr){
    	mbms_session_start_response_p->sm_mce_teid.ipv4_address= mce_config.mbms.ip.mc_mce_v4;
    ...
    if(memcmp(&mce_config.mbms.ip.mc_mce_v6.s6_addr, (void*)&in6addr_any, sizeof(mce_config.mbms.ip.mc_mce_v6.s6_addr)) != 0) {
    	memcpy(mbms_session_start_response_p->sm_mce_teid.ipv6_address.s6_addr, mce_config.mbms.ip.mc_mce_v6.s6_addr,  sizeof(mce_config.mbms.ip.mc_mce_v6.s6_addr));
