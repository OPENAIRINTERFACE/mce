  ...
  void)
{
  ...
  OAILOG_DEBUG (LOG_MCE_APP, "Connected M2 eNBs | %10u      |     %10u              |    %10u               |\n",mce_app_desc.nb_m2ap_enb_connected,
                                          mce_app_desc.nb_m2ap_enb_connected_since_last_stat, mce_app_desc.nb_m2ap_enb_released_since_last_stat);
  ...
  mce_app_desc.nb_m2ap_enb_connected_since_last_stat = 0;
  mce_app_desc.nb_m2ap_enb_released_since_last_stat  = 0;
...
void update_mce_app_stats_connected_m2ap_enb_add(void)
{
  mce_stats_write_lock (&mce_app_desc);
  (mce_app_desc.nb_m2ap_enb_connected)++;
  (mce_app_desc.nb_m2ap_enb_connected_since_last_stat)++;
  mce_stats_unlock(&mce_app_desc);
  return;
}
...
{
  mce_stats_write_lock (&mce_app_desc);
  if (mce_app_desc.nb_m2ap_enb_connected !=0)
    (mce_app_desc.nb_m2ap_enb_connected)--;
  (mce_app_desc.nb_m2ap_enb_released_since_last_stat)--;
  mce_stats_unlock(&mce_app_desc);
  return;
}
