...
static asn_oer_constraints_t asn_OER_type_M2AP_Cause_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_M2AP_Cause = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_M2AP_Cause_constr_1, &asn_PER_type_M2AP_Cause_constr_1, CHOICE_constraint },
