 ...
 */
static asn_oer_constraints_t asn_OER_type_M3AP_ProcedureCode_constr_1 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_M3AP_ProcedureCode = {
	...
	sizeof(asn_DEF_M3AP_ProcedureCode_tags_1)
		/sizeof(asn_DEF_M3AP_ProcedureCode_tags_1[0]), /* 1 */
	{ &asn_OER_type_M3AP_ProcedureCode_constr_1, &asn_PER_type_M3AP_ProcedureCode_constr_1, M3AP_ProcedureCode_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
