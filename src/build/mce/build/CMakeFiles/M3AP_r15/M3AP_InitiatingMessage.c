...
select_InitiatingMessage_M3AP_criticality_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	...
	const long *constraining_value = (const long *)((const char *)parent_sptr + offsetof(struct M3AP_InitiatingMessage, procedureCode));
...
static asn_type_selector_result_t
select_InitiatingMessage_M3AP_value_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	asn_type_selector_result_t result = {0, 0};
	const asn_ioc_set_t *itable = asn_IOS_M3AP_M3AP_ELEMENTARY_PROCEDURES_1;
	size_t constraining_column = 3; /* &procedureCode */
...
static asn_TYPE_member_t asn_MBR_M3AP_value_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct M3AP_InitiatingMessage__value, choice.MBMSSessionStartRequest),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct M3AP_InitiatingMessage__value, choice.MBMSSessionStopRequest),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct M3AP_InitiatingMessage__value, choice.MBMSSessionUpdateRequest),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct M3AP_InitiatingMessage__value, choice.Reset),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_M3AP_Reset,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct M3AP_InitiatingMessage__value, choice.M3SetupRequest),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct M3AP_InitiatingMessage__value, choice.MCEConfigurationUpdate),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct M3AP_InitiatingMessage__value, choice.ErrorIndication),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct M3AP_InitiatingMessage__value, choice.PrivateMessage),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_M3AP_value_tag2el_4[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 7 }, /* MBMSSessionStartRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, -1, 6 }, /* MBMSSessionStopRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, -2, 5 }, /* MBMSSessionUpdateRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, -3, 4 }, /* Reset */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 4, -4, 3 }, /* M3SetupRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 5, -5, 2 }, /* MCEConfigurationUpdate */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 6, -6, 1 }, /* ErrorIndication */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 7, -7, 0 } /* PrivateMessage */
};
static asn_CHOICE_specifics_t asn_SPC_M3AP_value_specs_4 = {
	sizeof(struct M3AP_InitiatingMessage__value),
	offsetof(struct M3AP_InitiatingMessage__value, _asn_ctx),
	offsetof(struct M3AP_InitiatingMessage__value, present),
	sizeof(((struct M3AP_InitiatingMessage__value *)0)->present),
...
asn_TYPE_member_t asn_MBR_M3AP_InitiatingMessage_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct M3AP_InitiatingMessage, procedureCode),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct M3AP_InitiatingMessage, criticality),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_M3AP_Criticality,
		select_InitiatingMessage_M3AP_criticality_type,
		{ &asn_OER_memb_M3AP_criticality_constr_3, &asn_PER_memb_M3AP_criticality_constr_3,  memb_M3AP_criticality_constraint_1 },
		0, 0, /* No default value */
		"criticality"
		},
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct M3AP_InitiatingMessage, value),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_M3AP_value_4,
		select_InitiatingMessage_M3AP_value_type,
		{ &asn_OER_memb_M3AP_value_constr_4, &asn_PER_memb_M3AP_value_constr_4,  memb_M3AP_value_constraint_1 },
		0, 0, /* No default value */
		"value"
		},
};
static const ber_tlv_tag_t asn_DEF_M3AP_InitiatingMessage_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_M3AP_InitiatingMessage_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* procedureCode */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* criticality */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* value */
};
asn_SEQUENCE_specifics_t asn_SPC_M3AP_InitiatingMessage_specs_1 = {
	sizeof(struct M3AP_InitiatingMessage),
	offsetof(struct M3AP_InitiatingMessage, _asn_ctx),
	asn_MAP_M3AP_InitiatingMessage_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_M3AP_InitiatingMessage = {
	"InitiatingMessage",
	"InitiatingMessage",
	&asn_OP_SEQUENCE,
	asn_DEF_M3AP_InitiatingMessage_tags_1,
	sizeof(asn_DEF_M3AP_InitiatingMessage_tags_1)
		/sizeof(asn_DEF_M3AP_InitiatingMessage_tags_1[0]), /* 1 */
	asn_DEF_M3AP_InitiatingMessage_tags_1,	/* Same as above */
	sizeof(asn_DEF_M3AP_InitiatingMessage_tags_1)
		/sizeof(asn_DEF_M3AP_InitiatingMessage_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_M3AP_InitiatingMessage_1,
	3,	/* Elements count */
	&asn_SPC_M3AP_InitiatingMessage_specs_1	/* Additional specs */
};
