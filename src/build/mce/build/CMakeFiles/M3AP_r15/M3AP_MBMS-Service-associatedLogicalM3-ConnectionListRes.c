...
static asn_oer_constraints_t asn_OER_type_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListRes_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..256)) */};
...
asn_TYPE_member_t asn_MBR_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListRes_1[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		&asn_DEF_M3AP_ProtocolIE_Single_Container_1240P0,
		0,
		{ 0, 0, 0 },
...
asn_TYPE_descriptor_t asn_DEF_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListRes = {
	...
	sizeof(asn_DEF_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListRes_tags_1)
		/sizeof(asn_DEF_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListRes_tags_1[0]), /* 1 */
	{ &asn_OER_type_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListRes_constr_1, &asn_PER_type_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListRes_constr_1, SEQUENCE_OF_constraint },
