...
static asn_oer_constraints_t asn_OER_type_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListResAck_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..256)) */};
asn_per_constraints_t asn_PER_type_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListResAck_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 8,  8,  1,  256 }	/* (SIZE(1..256)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListResAck_1[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_M3AP_ProtocolIE_Single_Container_1240P1,
		0,
		{ 0, 0, 0 },
...
asn_SET_OF_specifics_t asn_SPC_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListResAck_specs_1 = {
