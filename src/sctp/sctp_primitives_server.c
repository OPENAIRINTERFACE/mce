...
//------------------------------------------------------------------------------
int sctp_init (const mce_config_t * mce_config_p)
{
   ...
   */
  sctp_desc.nb_instreams = mce_config_p->sctp_config.in_streams;
  sctp_desc.nb_outstreams = mce_config_p->sctp_config.out_streams;
