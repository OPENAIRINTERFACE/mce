...
/** @mainpage
  ...
  openair-mce project tends to provide an implementation of LTE core network.
...
#ifndef FILE_OAISIM_MCE_SEEN
#define FILE_OAISIM_MCE_SEEN

int main(int argc, char *argv[]);

int oai_mce_log_specific(int log_level);

#endif /* FILE_OAISIM_MCE_SEEN */
